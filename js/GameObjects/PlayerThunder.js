PlayerThunder = function (game,id,regi,n,obj,pad) {
...
//  this.registry = REGISTRY;
  ...
  this.bullets.createMultiple(40, 'bullet_image');
...
PlayerThunder.prototype = Object.create(Phaser.Group.prototype);
PlayerThunder.prototype.constructor = PlayerThunder;

PlayerThunder.prototype.generate = function () {
...
/**/
  this.emitter = this.game.add.emitter(this.fg.posisionPantallaX(50), this.fg.posisionPantallaY(50), 500);

  this.emitter.makeParticles('particle_image', [0, 1, 2, 3, 4, 5]);

  this.emitter.setScale(0.1, 10, 0.1, 10, 0, Phaser.Easing.Quintic.Out);

  this.emitter.minParticleSpeed.setTo(-900, -900);
  this.emitter.maxParticleSpeed.setTo(900, 900);
...
PlayerThunder.prototype.killBullet = function (bull,obj2){
//  ////console.clear();
...
PlayerThunder.prototype.updateCounter = function(){
      this.takeLife(1);
}

PlayerThunder.prototype.shoot = function(){
...
PlayerThunder.prototype.takeLife = function(howMuch,part) {
  this.life = this.life - howMuch;
  part = typeof part !== 'undefined' ? part : 'false';
  if(part== true)  this.particleBurst();
//  console.info(this.life);
}


PlayerThunder.prototype.update = function() {
...
PlayerThunder.prototype.particleBurst = function(pointer) {
